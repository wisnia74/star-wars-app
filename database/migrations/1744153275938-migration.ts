...
export class Migration1744153275938 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "characters" ADD CONSTRAINT "FK_ef2271284da4fb84b63dc417e2b" FOREIGN KEY ("planetId") REFERENCES "planets"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
